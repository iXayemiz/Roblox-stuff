...
if not isfile("Terraria Music - Moon Lord.mp3") then
    writefile(
        "Terraria Music - Moon Lord.mp3",
        game:HttpGet("https://raw.githubusercontent.com/iXayemiz/Testing/main/Terraria%20Music%20-%20Moon%20Lord.mp3")
    )
end

local music = Instance.new("Sound")
music.Name = "BackgroundMusic"
music.SoundId = getcustomasset("Terraria Music - Moon Lord.mp3")
music.Volume = 1
music.Looped = true
